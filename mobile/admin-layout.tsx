...
/**
 * Gate de `/admin` en el bundle empaquetado.
 *
 ...
 * `superadmin` en /admin/users y devuelve 403 a cualquier otro token. Esto solo
 * evita que un usuario común llegue a una pantalla que se le va a llenar de
 * errores.
 */
