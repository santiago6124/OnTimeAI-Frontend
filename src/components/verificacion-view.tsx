/**
 * Render de la verificación de predicciones, sin fetch.
 *
 * Separado del componente que trae los vuelos por el mismo motivo que
 * `metric-cards-view.tsx`: la web los pide en el servidor durante el
 * render y el bundle nativo en el cliente al montar, pero lo que se ve en
 * pantalla tiene que ser un solo archivo.
 */
  ...
  return (
    <tr className="border-b transition-colors hover:bg-muted/30">
      <td className="py-2.5 pl-4 pr-3">
        <Link
          href={flightDetailHref(flight.fa_flight_id)}
